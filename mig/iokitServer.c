/*
 * IDENTIFICATION:
 * stub generated Tue Nov  1 17:47:01 2016
...
#pragma pack()
	...
	OutP->RetCode = is_io_connect_set_properties(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->properties.address), In0P->propertiesCnt, &OutP->result);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
...
#pragma pack()
	...
	OutP->RetCode = is_io_registry_entry_set_properties(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->properties.address), In0P->propertiesCnt, &OutP->result);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
...
#pragma pack()
	...
	RetCode = is_io_service_get_matching_services_ool(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->matching.address), In0P->matchingCnt, &OutP->result, &OutP->existing.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
...
#pragma pack()
	...
	OutP->RetCode = is_io_service_match_property_table_ool(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->matching.address), In0P->matchingCnt, &OutP->result, &OutP->matches);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
...
#pragma pack()
	...
	RetCode = is_io_service_open_extended(In0P->Head.msgh_request_port, In0P->owningTask.name, In0P->connect_type, In0P->ndr, (io_buf_ptr_t)(In0P->properties.address), In0P->propertiesCnt, &OutP->result, &OutP->connection.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
...
#pragma pack()
	...
	RetCode = is_io_service_add_notification_ool(In0P->Head.msgh_request_port, In0P->notification_type, (io_buf_ptr_t)(In0P->matching.address), In1P->matchingCnt, In0P->wake_port.name, In1P->reference, In1P->referenceCnt, &OutP->result, &OutP->notification.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
...
#pragma pack()
	...
	RetCode = is_io_service_get_matching_service_ool(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->matching.address), In0P->matchingCnt, &OutP->result, &OutP->service.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
...
#pragma pack()
	...
	RetCode = is_io_registry_entry_from_path_ool(In0P->Head.msgh_request_port, In0P->path, (io_buf_ptr_t)(In0P->path_ool.address), In1P->path_oolCnt, &OutP->result, &OutP->registry_entry.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
